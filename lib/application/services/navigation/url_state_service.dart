...
import 'package:prioris/application/services/navigation/list_resolution_service.dart';
...
class UrlStateService {
  ...
  UrlStateService(this._context, this._ref);
  ...
  void updateUrlToResolvedList(String resolvedListId) {
    print('🔗 UrlStateService: Updating URL to reflect resolved list: $resolvedListId');
...
/// Provider for the URL state service
///
/// Note: This provider requires both BuildContext and WidgetRef,
/// so it's typically used within widget build methods
final urlStateServiceProvider = Provider.family<UrlStateService, BuildContext>((ref, context) {
  return UrlStateService(context, ref);
});
