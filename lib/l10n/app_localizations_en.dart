...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get habitsRecordValueTooltip => 'Record a value';
  ...
  @override
  String get consentGateSignOutError => 'Sign-out failed. Please try again.';

  @override
  String get consentGateActionPrompt => 'What would you like to do?';
  ...
  String importInterruptedBanner(int current, int total) {
    return 'Import interrupted — $current/$total items added';
  }
  ...
  @override
  String get importDoNotClose => 'Do not close the application during import';

  @override
  String importResumeBanner(int current, int total, int remaining) {
    return 'Import interrupted — $current/$total added · $remaining pending';
  }

  @override
  String get importResumeConfirm => 'Resume';
  ...
  @override
  String get onboardingCaptureTitle => 'What\'s on your mind right now?';

  @override
  String get onboardingCaptureHint => 'One task per line. Don\'t overthink it.';
  ...
  @override
  String get onboardingArchetypesLabel => 'Quick ideas';
  ...
  String onboardingTasksRemaining(int remaining) {
    String _temp0 = intl.Intl.pluralLogic(
      remaining,
      locale: localeName,
      other: 'Add $remaining more tasks to start',
      one: 'Add 1 more task to start',
    );
    return '$_temp0';
  }
  ...
  String onboardingDuelIntro(int total) {
    return 'You\'ll make $total choices. No ranking, no numbers to manage — you decide.';
  }
  ...
  @override
  String get onboardingRevealContinue => 'Continue';

  @override
  String get onboardingRevealMarkDone => 'Mark as done';

  @override
  String get onboardingSkip => 'Skip';

  @override
  String get onboardingArchetypeSport => 'Exercise';

  @override
  String get onboardingArchetypeCall => 'Call a loved one';

  @override
  String get onboardingArchetypeReport => 'Finish the report';

  @override
  String get onboardingArchetypeEmails => 'Sort my emails';

  @override
  String get onboardingArchetypeGroceries => 'Buy groceries';

  @override
  String get onboardingArchetypeRead => 'Read 10 pages';

  @override
  String get onboardingArchetypeTidy => 'Tidy my desk';
