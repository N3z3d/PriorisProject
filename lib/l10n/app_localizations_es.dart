...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get settingsRevokeConsentTile => 'Retirar mi consentimiento';

  @override
  String get settingsRevokeConsentSubtitle =>
      'Revocar el acceso a sus datos personales';

  @override
  String get settingsRevokeConsentDialogTitle => 'Retirar su consentimiento';

  @override
  String get settingsRevokeConsentDialogBody =>
      'Será redirigido inmediatamente a la página de consentimiento. Puede aceptar de nuevo en cualquier momento.';

  @override
  String get settingsRevokeConsentDialogConfirm => 'Retirar';

  @override
  String get settingsRevokeConsentDialogCancel => 'Cancelar';
  ...
  String get importDoNotClose =>
      'No cierre la aplicación durante la importación';

  @override
  String importResumeBanner(int current, int total, int remaining) {
    return 'Importación interrumpida — $current/$total añadidos · $remaining pendientes';
  }

  @override
  String get importResumeConfirm => 'Reanudar';
